...
public abstract class Planta {
	...
	public void setAmbiente(Ambiente ambiente) {
        ...
        public void setTamanho(int tamanho) throws TamNegException, TamGrdException {
            if (tamanho <= 0) {
            // Lança a exceção com uma mensagem clara
            throw new TamNegException("Tamanho deve ser positivo e maior que 0!");
            }
            if (tamanho >= 200) {
            // Lança a exceção com uma mensagem clara
            throw new TamGrdException("Tamanho deve ser menor de 200cm!");
            }
            this.tamanho = tamanho;
    }
